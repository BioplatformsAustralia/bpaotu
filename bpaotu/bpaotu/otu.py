...
class SampleEnvironmentMaterial(OntologyMixin, Base):
    pass
...
class SampleContext(SchemaMixin, Base):
    ...
    # store_cond = Column(CIText)
    # biotic_relationship = Column(CIText)
    # env_medium = Column(CIText)
    # env_material = Column(CIText)
    # env_broad_scale = Column(CIText)
    # env_local_scale = Column(CIText)
    # general_env_feature = Column(CIText)
    # vegetation_type = Column(CIText)
    notes = Column(CIText)
    depth_lower = Column(Float)
    depth_upper = Column(Float)
    depth = Column(Float)
    # sample_type = Column(CIText)
    ...
    ammonium_nitrogen_vol = Column(Float)
    ammonium_nitrogen_vol_meth = Column(CIText)
    anth = Column(Float)
    ...
    course_sand_meth = Column(CIText)
    cphl_a = Column(Float)
    cphl_a_meth = Column(CIText)
    cphl_b = Column(Float)
    cphl_b_meth = Column(CIText)
    cphl_c1c2 = Column(Float)
    cphl_c1c2_meth = Column(CIText)
    cphl_c1 = Column(Float)
    cphl_c1_meth = Column(CIText)
    cphl_c2 = Column(Float)
    cphl_c2_meth = Column(CIText)
    cphl_c3 = Column(Float)
    cphl_c3_meth = Column(CIText)
    ...
    ctdchlf = Column(Float)
    ctdchlf_meth = Column(CIText)
    # cur_land_use = Column(CIText)
    ...
    # immediate_previous_land_use = Column(CIText)
    ...
    porewater_ph_meth = Column(CIText)
    ...
    # profile_position = Column(CIText)
    ...
    env_material_id = ontology_fkey(SampleEnvironmentMaterial, default=0)
    ...
    cur_land_use_id = ontology_fkey(SampleLandUse, default=0)
