  ...
  return [
    {
      content: () => {
        return (
          <div>
            <span>
              <h4>Welcome to Australian Microbiome Data Barcode Products Portal</h4>
              <br />
              ...
              .<br />
              <br />
              Let's start with a brief introduction and example to the portal. <br />
        ...
        return (
          <div>
            <span>
              ...
              <br />
              We first need to select an amplicon. In our example case amplicon ==
              '27f519r_bacteria'.
              <br />
              <br />
              This selection will cause the lower level taxonomies to filtered to those available in
              the upper selection. We now need to select our target kingdom and phylum.
              <br />
              <br />
              Select Kingdom is 'd__Bacteria' to keep only sequences hitting the bacterial target
              the primers were designed for.
              <br />
              <br />
              Select Phylum is 'p__Verrucomicrobiota'.
              <br />
              <br />
              For more details about taxonomy selection{' '}
              <a
                rel="noopener noreferrer"
                target="_bpaotu"
                href={
        ...
        return (
          <div>
            <span>
              ...
              <p>
                <i>
                  Note that, no selection here (---) will include both terrestrial and marine
                  samples to subsequent steps.
                </i>
              </p>
              ...
              <p>
                <i>
                  Note: Matching filters will be suggested after typing few characters on the
                  dropdown list
                </i>
              </p>
              <ul>
        ...
        return (
          <div>
            <span>
              ...
              <br />
              Now that the search parameters are entered hit "search" and the data requested will be
              returned.
              <br />
            </span>
          </div>
        ...
        return (
          <div>
            <span>
              ...
              <br />
              Click the 'Interactive map search' button
              <br />
              <br />
              This will load a map of the location of the selected samples
              <br />
            </span>
          </div>
        )
        ...
        return (
          <div>
            <span>
              ...
              <br />
              <br />
              You can toggle the features by selecting layers button on the right.
              <br />
              <br />
        ...
        return (
          <div>
            <span>
              ...
              <br />
              Click close button to close Map View.
              <br />
            </span>
          </div>
        )
        ...
        return (
          <div>
            <span>
              ...
              <br />
              We can also explore the data visually.
              <br />
              <br />
              Click the 'Interactive graph search' button.
              <br />
            </span>
          </div>
        )
        ...
        return (
          <div>
            <span>
              ...
              <p>
                Follow "Tutorial" link on the top of the interactive graph visualisation page for
                more information.
              </p>
            </span>
          </div>
        ...
        return (
          <div>
            <span>
              ...
              <br />
              Click close button to close Graph View.
              <br />
            </span>
          </div>
        )
        ...
        return (
          <div>
            <span>
              ...
              <br />
              <br />
              The full export option will export both the metadata and the ASV table
              <br />
            </span>
          </div>
        )
        ...
        return (
          <div>
            <span>
              ...
              <br />
              It is also possible to export the data in a BIOM format (JSON) that is compatible with
              PHINCH (
        ...
        return (
          <div>
            <span>
              ...
              <br />
              Data can be exported to Galaxy Australia for further analysis by clicking the 'Export
              data to Galaxy for further analysis' button
              <br />
        ...
        return (
          <div>
            <span>
              ...
              <br />
              We can make a krona plot from the selected organisms by selecting the 'Export Data to
              Galaxy Australia for Krona Taxonomic Abundance Graph'
              <br />
              <br />
        ...
        return (
          <div>
            <span>
              ...
              <br />
              If you have any queries, please click on the contact link
              <br />
              <br />
            </span>
          </div>
