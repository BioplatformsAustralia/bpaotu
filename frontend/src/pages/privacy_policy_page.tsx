...
export default (props) => {
  ...
  return (
    <Container fluid={true} style={{ marginTop: 10, width: "50%" }}>
      ...
      <p>
        This privacy notice for the Bioplatforms OTU Search Facility ('we',
      ...
      <ul>
        <li>
          Visit our website at https://data.bioplatforms.com/bpa/otu, or any
          website of ours that links to this privacy notice
        </li>
        <li>
          Engage with us in other related ways, including any data requests
        </li>
      </ul>
      ...
      <p>
        Please note that the Bioplatforms OTU Search Facility is hosted on the
        Bioplatforms Australia Data Portal and is covered by the Terms and
        Conditions and Privacy Policy defined at
        https://bioplatforms.com/terms-and-conditions/. This Privacy Policy
        covers additional points specific to the Bioplatforms OTU Search
        Facility.
      </p>
      ...
      <p>
        ...
        information depending on how you interact with Bioplatforms OTU Search
        Facility and the Services, the choices you make, and the features you
        use.
      </p>
      ...
      <p>
        ...
        with law. Any personal information we process is anonymised before being
        used. This means that no personally identifying information is shared
        with external parties. We process your information only when we have a
      ...
      <p>
        ...
        We do not share and personally identifying information with third
      ...
      <p>
        We do not share your peronsal information with any third parties. We do
        share anonymised information on site usage with third parties to aid us
        with the analysis of data on the Services we provide.
      </p>
      ...
      <p>
        ...
        before using Bioplatforms OTU Search Facility (“website”, "service")
        operated by Bioplatforms Australia ("us", 'we", "our").
      </p>
      ...
      <p>
        ...
        please contact us at help@bioplatforms.com.
      </p>
    </Container>
  );
};
