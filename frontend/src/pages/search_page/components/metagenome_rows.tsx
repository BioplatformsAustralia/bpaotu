export const metagenome_rows = [
    ...
    ["Filtered  sequencing reads",
        "Quality filtered fastq.gz files",
        "qc.fastq.zip"],
    ...
    ["Annotation",
        ...
        "sqm.03.gff"],
    ["Annotation",
        "Result of the homology search for COG",
        "sqm.04.eggnog.diamond"],
    ["Annotation",
        "Result of the homology search for KEGG",
        "sqm.04.kegg.diamond"],
    ["Annotation",
        "Result of the homology search for nr",
        "sqm.04.nr.diamond"],
    ["Annotation",
        "Results of the HMM search",
        "sqm.05.pfam.hmm"],
    ["Annotation",
    ...
    ["Annotation",
        ...
        "sqm.07.fun3.pfam"],
    ["Annotation",
        "Assignment of contigs based on ORFs annotations",
        "sqm.09.contiglog"],
    ["Annotation",
    ...
    ["Annotation statistics",
        "Abundance of all taxa for each read",
        "sqmreads.out.allreads.mcount"],
    ["Annotation statistics",
        "Summary of total reads and hits to nr for each read",
        "sqmreads.out.mappingstat"],
    ["Analysis information",
        "Methods used by Squeezemeta reads",
        "sqmreads.out.methods.txt"],
    ...
    ["Checksum for Squeezemeta workflow",
        "md5 checksum file",
        "sqm.md5"],
    ["checksum for SQM reads - sampleID.md5",
        "md5 checksum file",
        "sqmreads.out.md5"],
]
