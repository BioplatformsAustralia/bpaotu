...
export class GridCellLegendControl extends MapControl {
...
export class HeatMapLegendControl extends MapControl {
  static outlineOpacity = 0;
  ...
  componentWillMount() {
    ...
    legend.onAdd = function (map) {
        const div = L.DomUtil.create("div", "");
        const levels = [0.0, 0.4, 0.6, 0.7, 0.8, 1.0];
        let labels = [];
        let from;
        let to;
