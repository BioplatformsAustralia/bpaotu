          ...
          <Nav tabs>
            ...
            <NavItem>
              <NavLink
                ...
                className={classnames({
                  active: this.props.tabSelected === 'tab_am_environment_id',
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                ...
                className={classnames({
                  active: this.props.tabSelected === 'tab_taxonomy_am_environment_id',
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                ...
                className={classnames({
                  active: this.props.tabSelected === 'tab_traits_am_environment_id',
                })}
                onClick={() => {
